...
?>
			...
			<div class="ip-box">
				...
				<div class="row">
					<div class="ip-config" name="ip_config" id="ip_config">
						...
						?>
						<textarea rows="20" id="IP_ITEMS" class='ip-item' onkeypress="if(event.keyCode === 32 || event.which === 32) { line_feed(); }"><?= $en_patern ?></textarea>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function line_feed() {
			document.getElementById("IP_ITEMS").value += '\n';
		}
	</script>
<?php
}
